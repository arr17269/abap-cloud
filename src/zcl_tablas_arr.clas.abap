CLASS zcl_tablas_arr DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_tablas_arr IMPLEMENTATION.
 METHOD if_oo_adt_classrun~main.

    data lv_nombre TYPE ZDE_ELEMENTO_ARR.
    data lt_edad TYPE TABLE of /dmo/airport.


    out->write( lt_edad ).

*  types: BEGIN OF ty_persona,
*       nombre   TYPE ZDE_ELEMENTO_ARR,
