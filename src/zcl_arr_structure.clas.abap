CLASS zcl_arr_structure DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_ARR_STRUCTURE IMPLEMENTATION.
...
*   DATA address TYPE st_address.
   DATA address TYPE zARRs_address.
...
*    DATA person2 TYPE st_person_inc.
    DATA person2 TYPE zARRs_person_incl.
